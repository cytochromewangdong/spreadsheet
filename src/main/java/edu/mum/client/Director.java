...
public class Director {
	public void fillSampleSheet(SpreadSheet sheet) {
		...
		sheet.setCellValue(1, 2, "(200*4)/2+5*(18-1)+0.15");	// 6885.15
		...
		sheet.setCellValue(3, 2, "295.0+0.85");	// 295.85
		sheet.setCellValue(4, 1, "Hotel:");
		sheet.setCellValue(4, 2, "108.0*4.0");	// 432
		...
		sheet.setCellValue(7, 2, "[1,2]+[2,2]+[3,2]+[4,2]+[5,2]");	// 7881
		sheet.setCellValue(8, 1, "Discount:");
		sheet.setCellValue(8, 2, 0.15);
		sheet.setCellValue(9, 1, "Total:");
		sheet.setCellValue(9, 2, "[7,2]*(1-[8,2])");	// 6698.85
		...
		sheet.setCellValue(12, 2, "[9,2]/[10,2]/[11,2]");	// 139.559375
	}
}
